...
public class TaskTester {
        ...
        public static void main(String[] args) {
                ...
                // Create some tasks
                Task task1 = new Task("Finish report", LocalDateTime.now().plusDays(2), 3, 120, false);
                Task task2 = new Task("Buy groceries", LocalDateTime.now().plusHours(5), 4, 30, false);
                Task task3 = new Task("Call mom", LocalDateTime.now().plusHours(1), 5, 15, false);
